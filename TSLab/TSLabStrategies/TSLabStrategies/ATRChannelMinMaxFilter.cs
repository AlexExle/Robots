...
namespace TSLabStrategies
{
    public class ATRChannelMinMaxFilter : IExternalScript
    {
        ...
        public void Execute(IContext ctx, ISecurity sec)
        {
            ...
            pricePane.AddList("Prev Day High Level", highPrefDayLevel, ListStyles.LINE, 0xa000a0, LineStyles.DOT, PaneSides.RIGHT);
            pricePane.AddList("Prev Day Low Level", lowPrefDayLevel, ListStyles.LINE, 0xa000a0, LineStyles.DOT, PaneSides.RIGHT);
