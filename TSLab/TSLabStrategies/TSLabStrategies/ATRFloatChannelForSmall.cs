...
{
    public class ATRFloatChannelForSmall : IExternalScript
    {
        ...
        public ATRFloatChannelForSmall()
        {
        ...
        public void Execute(IContext ctx, ISecurity sec)
        {
            ...
            for (int bar = 0; bar < sec.Bars.Count; bar++)
            {
                ...
                highLevelSeries2.Add(((calcPrice + (atr[bar] * multiplier.Value * 2)) / 100d) * 100);
                lowLevelSeries2.Add(((calcPrice - (atr[bar] * multiplier.Value * 2)) / 100d) * 100);
